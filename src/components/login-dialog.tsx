...
export function LoginDialog({ isOpen, setIsOpen }: LoginDialogProps) {
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="lg:text-2xl font-bold tracking-normal">Entrar</DialogTitle>
          <DialogDescription>Faça login para começar a usar. Escolha um provedor abaixo.</DialogDescription>
        </DialogHeader>

        <Button variant="outline" className="w-full h-14" onClick={() => signIn("google")}>
