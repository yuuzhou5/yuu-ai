...
const ChatBubbleAvatar = React.memo<ChatBubbleAvatarProps>(
...
const chatBubbleMessageVariants = cva("p-4", {
  variants: {
    variant: {
      ...
      sent: "bg-secondary rounded-l-lg rounded-tr-lg",
    },
    layout: {
      default: "",
...
const ChatBubbleMessage = React.memo(
...
const ChatBubbleTimestamp = React.memo<ChatBubbleTimestampProps>(
...
const ChatBubbleAction = React.memo<ChatBubbleActionProps>(
  ({
    icon,
    onClick,
    className,
...
const ChatBubbleActionWrapper = React.memo(
